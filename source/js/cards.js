...
export const productsDatabase = {
    ...
    pastries: [
        ...
        {
            id: 12,
            name: 'Пирожное “Шоколадное” с трюфельным кремом',
            category: 'pastries',
            price: 126,
            oldPrice: 139,
        ...
        {
            id: 16,
            name: 'Рулет бисквитный шоколадный',
            category: 'pastries',
            price: 75,
            oldPrice: null,
    ...
    cakes: [
        {
            id: 21,
            name: 'Торт Шоколадный с кремом чиз и клубникой',
            category: 'cakes',
            price: 599,
            oldPrice: null,
            imagePng: cakes21Png,
        ...
        {
            id: 22,
            name: 'Торт Ягодный с йогуртовой начинкой',
            category: 'cakes',
            price: 659,
            oldPrice: null,
            imagePng: cakes22Png,
    ...
    breakfasts: [
        {
            id: 31,
            name: 'Блины с вишневой начинкой 3 штуки',
            category: 'breakfasts',
            price: 289,
            oldPrice: null,
        ...
        {
            id: 32,
            name: 'Сырники 5 штук с начинкой на выбор',
            category: 'breakfasts',
            price: 358,
            oldPrice: null,
    ...
    drinks: [
        ...
        {
            id: 74,
            name: 'Фраппе с карамелью и орехами',
            category: 'drinks',
            price: 220,
            oldPrice: null,
